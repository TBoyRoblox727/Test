...
v0.new("<Color=Cyan>Tổng Tài Bá Đạo<Color=/>"):Display();
wait(0.5);
v0.new("<Color=Yellow>ShiTV Hub v3<Color=/>"):Display();
wait(1);
repeat
    wait();
...
wait(1.0)
Tabs.Info:AddButton({
        Title="ShiTV Community",
        Description="Discord",
        Callback=function()
            setclipboard(tostring("https://discord.gg/jaTx2C2Jpw")) 
        end
})
Tabs.Info:AddButton({
    Title="ShiTV",
    Description="Youtube",
    Callback=function()
        setclipboard(tostring(" https://youtube.com/@shitv1155?si=RLuK2SpaJ9RuvRGt"))
    end
})
local executorName
